...
namespace ProjektBerga.Server.Migrations
{
    ...
    [Migration("20220814114601_Ispravak")]
            ...
            modelBuilder.Entity("ProjektBerga.Shared.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CategoryId = 1,
                            DateCreated = new DateTime(2022, 8, 14, 13, 46, 0, 401, DateTimeKind.Local).AddTicks(1985),
                        ...
                        new
                        {
                            Id = 2,
                            CategoryId = 1,
                            DateCreated = new DateTime(2022, 8, 14, 13, 46, 0, 409, DateTimeKind.Local).AddTicks(2816),
                            DateUpdated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Description = " 2GB RAM",
                        ...
                        new
                        {
                            Id = 3,
                            CategoryId = 2,
                            DateCreated = new DateTime(2022, 8, 14, 13, 46, 0, 409, DateTimeKind.Local).AddTicks(3006),
                            DateUpdated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = 4,
                            CategoryId = 2,
                            DateCreated = new DateTime(2022, 8, 14, 13, 46, 0, 409, DateTimeKind.Local).AddTicks(3020),
                            DateUpdated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = 5,
                            CategoryId = 3,
                            DateCreated = new DateTime(2022, 8, 14, 13, 46, 0, 409, DateTimeKind.Local).AddTicks(3030),
                            DateUpdated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
